...
| Glitch FX | CSS-only (no canvas/WebGL/video) | scanlines + noise 3–6%, 100–400ms grayscale-offset bursts |
...
| Var | Purpose |
|---|---|
| FILL | EmailOctopus API key |
| FILL | EmailOctopus list/from address |
| FILL | (anything else — e.g. revalidation secret) |
